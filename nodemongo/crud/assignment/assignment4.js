...
function queryDocument(options) {
    ...
    if ("overview" in options) {
        ...
        */
       var overview_query = {"overview": {"$regex": options.overview , "$options": "i"}};

       var taglist_query = {"tag_list": {"$regex": options.overview , "$options": "i"}};

       query = { $or : [ overview_query,  taglist_query ] };
    }
